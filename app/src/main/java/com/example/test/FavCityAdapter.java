...
public class FavCityAdapter extends RecyclerView.Adapter<FavCityAdapter.ViewHolder> {
    ...
    private ArrayList<com.example.test.FavCityModel> arr;

    public FavCityAdapter(Context context, ArrayList<com.example.test.FavCityModel> arr) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.test.FavCityModel obj = arr.get(position);
